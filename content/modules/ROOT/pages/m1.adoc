...
[start=5]
.. Alternatively, http://ui-super-heroes-quarkus-superheroes-{openshift_cluster_user_name}.{_ocp4_workload_acc_new_app_dev_wildcard_domain}[click here,window=_blank] for direct access.
